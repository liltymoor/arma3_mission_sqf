...
class GarageMenu
{
	...
	class Controls
	{
		...
		class Control757064
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			action = "lbClear 3614;[3614] call PENA_FNC_PREVEHARRAY; ctrlEnable [14141, true]; ctrlEnable [14142, true]; ctrlEnable [14143, false]; ctrlEnable [14144, true];"
		};
		class Control24773411
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			action = "lbClear 3614;[3614] call PENA_FNC_PREHELIARRAY; ctrlEnable [14141, true]; ctrlEnable [14142, true]; ctrlEnable [14143, true]; ctrlEnable [14144, false];"
		};
			class LifesCount
		{
			type = 13;

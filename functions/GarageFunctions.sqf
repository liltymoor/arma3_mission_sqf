...
while {!IsNull (FindDisplay 12343891)} do {
  ...
  switch (true) do {
  case (_vehicle isKindOf "I_MRAP_03_hmg_F") : {_cost = 4590; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\soft_f_beta\MRAP_03\Data\UI\MRAP_03_HMG_ca.paa'/>";};//Страйдер 12.7
  case (_vehicle isKindOf "I_MRAP_03_gmg_F") : {_cost = 4590; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\soft_f_beta\MRAP_03\Data\UI\MRAP_03_RCWS_ca.paa'/>";};//Страйдер ГП
  ...
  case (_vehicle isKindOf "I_LT_01_AA_F") : {_cost = 6650; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Armor_F_Tank\LT_01\data\UI\LT_01_AA.paa'/>";};//Нюкс ПВ
  ...
  case (_vehicle isKindOf "B_Heli_Transport_01_camo_F") : {_cost = 12250; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F_Beta\Heli_Transport_01\Data\UI\Heli_Transport_01_base_CA.paa'/>";};//Госта

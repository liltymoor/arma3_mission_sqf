...
while {!IsNull (FindDisplay 1234389)} do {
  ...
  case (_vehicle isKindOf "B_AFV_Wheeled_01_up_cannon_F") : {_lifes = (_loadedLifes select 2);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Рино
  case (_vehicle isKindOf "I_MBT_03_cannon_F") : {_lifes = (_loadedLifes select 3);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Кума
  case (_vehicle isKindOf "O_MBT_04_command_F") : {_lifes = (_loadedLifes select 4);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Ангара
  case (_vehicle isKindOf "O_MBT_02_cannon_F") : {_lifes = (_loadedLifes select 5);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Варсук
  case (_vehicle isKindOf "B_MBT_01_cannon_F") : {_lifes = (_loadedLifes select 6);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Сламмер
  case (_vehicle isKindOf "B_APC_Wheeled_01_cannon_F") : {_lifes = (_loadedLifes select 7);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Маршалл
  case (_vehicle isKindOf "I_APC_tracked_03_cannon_F") : {_lifes = (_loadedLifes select 8);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Мора
  case (_vehicle isKindOf "I_APC_Wheeled_03_cannon_F") : {_lifes = (_loadedLifes select 9);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Горгона
  case (_vehicle isKindOf "O_APC_Tracked_02_cannon_F") : {_lifes = (_loadedLifes select 10);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Камыш
  case (_vehicle isKindOf "I_LT_01_AA_F") : {_lifes = (_loadedLifes select 11);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Нюкс ПВ
  case (_vehicle isKindOf "O_APC_Tracked_02_AA_F") : {_lifes = (_loadedLifes select 12);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Тигрис
  case (_vehicle isKindOf "B_APC_Tracked_01_AA_F") : {_lifes = (_loadedLifes select 13);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Читаха
  case (_vehicle isKindOf "B_Heli_Transport_01_camo_F") : {_lifes = (_loadedLifes select 14);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Госта
  case (_vehicle isKindOf "O_Heli_Light_02_F") : {_lifes = (_loadedLifes select 15);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//орка
  case (_vehicle isKindOf "I_Heli_light_03_F") : {_lifes = (_loadedLifes select 16);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//Хелка
  case (_vehicle isKindOf "O_Heli_Attack_02_F") : {_lifes = (_loadedLifes select 17);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//кайман
  case (_vehicle isKindOf "B_Heli_Attack_01_F") : {_lifes = (_loadedLifes select 18);((Finddisplay 1234389) displayCtrl 131214) ctrlSetText format ["%1", _lifes];};//бф
...
FREDDT_FNC_LOADARMOREDLANDVEH = {
 [] spawn {
 _vehArray = ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "B_AFV_Wheeled_01_up_cannon_F", "I_MBT_03_cannon_F", "O_MBT_04_command_F", "O_MBT_02_cannon_F", "B_MBT_01_TUSK_F", "B_APC_Wheeled_01_cannon_F", "I_APC_tracked_03_cannon_F", "O_APC_Tracked_02_cannon_F", "I_LT_01_AA_F", "I_APC_Wheeled_03_cannon_F", "O_APC_Tracked_02_AA_F", "B_APC_Tracked_01_AA_F"];
{
  _vehName = getText (configFile >> "CfgVehicles" >> _x >> "displayname");  
  lbAdd [3615, _vehName];
...
while {!IsNull (FindDisplay 12343891)} do {
  ...
  case (_vehicle isKindOf "B_AFV_Wheeled_01_up_cannon_F") : {_cost = 6300; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Armor_F_Tank\AFV_Wheeled_01\Data\UI\AFV_Wheeled_01_up_cannon.paa'/>";};//Рино
  ...
  case (_vehicle isKindOf "B_APC_Wheeled_01_cannon_F") : {_cost = 3560; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\armor_f_beta\APC_Wheeled_01\Data\UI\APC_Wheeled_01_ACRV_ca.paa'/>";};//Маршалл
  case (_vehicle isKindOf "I_APC_tracked_03_cannon_F") : {_cost = 3950; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Armor_F_EPB\APC_Tracked_03\Data\UI\APC_Tracked_03_Base_ca.paa'/>";};//Мора
  ...
  case (_vehicle isKindOf "O_APC_Tracked_02_cannon_F") : {_cost = 11140; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\armor_f_beta\APC_Tracked_02\Data\UI\APC_Tracked_02_cannon_ca.paa'/>";};//Камыш
  ...
  case (_vehicle isKindOf "O_Heli_Light_02_F") : {_cost = 22000; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F\Heli_Light_02\Data\UI\Heli_Light_02_rockets_CA.paa'/>";};//Орка
  case (_vehicle isKindOf "I_Heli_light_03_F") : {_cost = 11570; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F_EPB\Heli_Light_03\data\UI\Heli_Light_03_CA.paa'/>";};//Хелка
  case (_vehicle isKindOf "O_Heli_Attack_02_F") : {_cost = 40000; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F_Beta\Heli_Attack_02\Data\UI\Heli_Attack_02_CA.paa'/>";};//Кайман
  case (_vehicle isKindOf "B_Heli_Attack_01_F") : {_cost = 46000; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F_Beta\Heli_Attack_01\Data\UI\Heli_Attack_01_CA.paa'/>";};//Бфка
  sleep 0.1;
      };
    };
  };
...
FREDDT_FNC_LOADARMOREDAIRVEH = {
 [] spawn {
 _vehArray = ["B_Heli_Transport_01_camo_F", "O_Heli_Light_02_F", "I_Heli_light_03_F", "O_Heli_Attack_02_F", "B_Heli_Attack_01_F"];
{
  _vehName = getText (configFile >> "CfgVehicles" >> _x >> "displayname");  
  lbAdd [3615, _vehName];
  lbSetData [3615, _forEachIndex, _x];
...
PENA_CREATING_VEH = {
  ...
  case ((_heliArray find _vehicle) != -1 ) : { 
    ...
    case (_vehicle isKindOf "B_AFV_Wheeled_01_up_cannon_F") : {_lifes = (_loadedLifes select 2);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Рино
    case (_vehicle isKindOf "I_MBT_03_cannon_F") : {_lifes = (_loadedLifes select 3);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Кума 
    case (_vehicle isKindOf "O_MBT_04_command_F") : {_lifes = (_loadedLifes select 4);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Ангара 
    case (_vehicle isKindOf "O_MBT_02_cannon_F") : {_lifes = (_loadedLifes select 5);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Варсук 
    case (_vehicle isKindOf "B_MBT_01_cannon_F") : {_lifes = (_loadedLifes select 6);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Сламмер
    case (_vehicle isKindOf "B_APC_Wheeled_01_cannon_F") : {_lifes = (_loadedLifes select 7);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Маршалл
    case (_vehicle isKindOf "I_APC_tracked_03_cannon_F") : {_lifes = (_loadedLifes select 8);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Мора
    case (_vehicle isKindOf "I_APC_Wheeled_03_cannon_F") : {_lifes = (_loadedLifes select 9);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Горгона
    case (_vehicle isKindOf "O_APC_Tracked_02_cannon_F") : {_lifes = (_loadedLifes select 10);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Камыш
    case (_vehicle isKindOf "I_LT_01_AA_F") : {_lifes = (_loadedLifes select 11);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Тигрис 
    case (_vehicle isKindOf "O_APC_Tracked_02_AA_F") : {_lifes = (_loadedLifes select 12);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Тигрис 
    case (_vehicle isKindOf "B_APC_Tracked_01_AA_F") : {_lifes = (_loadedLifes select 13);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Читаха
    case (_vehicle isKindOf "B_Heli_Transport_01_camo_F") : {_lifes = (_loadedLifes select 14);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Госта 
    case (_vehicle isKindOf "O_Heli_Light_02_F") : {_lifes = (_loadedLifes select 15);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//орка
    case (_vehicle isKindOf "I_Heli_light_03_F") : {_lifes = (_loadedLifes select 16);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//Хелка 
    case (_vehicle isKindOf "O_Heli_Attack_02_F") : {_lifes = (_loadedLifes select 17);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//кайман 
    case (_vehicle isKindOf "B_Heli_Attack_01_F") : {_lifes = (_loadedLifes select 18);((Finddisplay 60100) displayCtrl 60002) ctrlSetText format ["%1", _lifes];};//бф 

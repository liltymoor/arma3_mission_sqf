...
FREDDT_FNC_LOADARMOREDLANDVEH = {
 [] spawn {
 _vehArray = ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "B_AFV_Wheeled_01_up_cannon_F", "I_MBT_03_cannon_F", "O_MBT_04_command_F", "O_MBT_02_cannon_F", "B_MBT_01_TUSK_F", "B_APC_Wheeled_01_cannon_F", "I_APC_tracked_03_cannon_F", "I_LT_01_AA_F", "I_APC_Wheeled_03_cannon_F", "O_APC_Tracked_02_AA_F", "B_APC_Tracked_01_AA_F"];
{
  _vehName = getText (configFile >> "CfgVehicles" >> _x >> "displayname");  
  lbAdd [3615, _vehName];
...
while {!IsNull (FindDisplay 12343891)} do {
  ...
  case (_vehicle isKindOf "B_AFV_Wheeled_01_up_cannon_F") : {_cost = 5430; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Armor_F_EPB\MBT_03\Data\UI\MBT_03_Ca.paa'/>";};//Рино
  ...
  case (_vehicle isKindOf "I_Heli_light_03_F") : {_cost = 22000; globalCost = _cost; ((Finddisplay 12343891) displayCtrl 7777) ctrlSetText format ["%1", _cost]; ((Finddisplay 12343891) displayCtrl 777) ctrlSetStructuredText parseText "<img size = '3' align='center' valign='bottom' image='\A3\Air_F\Heli_Light_02\Data\UI\Heli_Light_02_rockets_CA.paa'/>";};//Хелка

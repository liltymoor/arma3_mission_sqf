...
while {!IsNull (FindDisplay 123438)} do {
 ...
 _bluforArray = ["jp_Helmet", "jp_HelmetHBK", "jp_cap", "jp_booniehat", "jp_beret", "", "jp_soldier", "jp_ghillie", "jp_bandit_tshirt", "jp_bandit_undershirt", "jp_polo", "", "jp_platevest_ctrg_1", "jp_platevest_ctrg_2", "jp_platevest_2", "jp_platevest", "", "jp_Backpack_Fast", "jp_Messenger", "jp_Viper"];
 ...
 _independentArray = ["fr_Helmet", "fr_HelmetHBK", "fr_cap", "fr_booniehat", "fr_beret", "", "fr_soldier", "fr_ghillie", "fr_bandit_tshirt", "fr_bandit_undershirt", "fr_polo", "", "fr_platevest_ctrg_1", "fr_platevest_ctrg_2", "fr_platevest_2", "fr_platevest", "", "fr_Backpack_Fast", "fr_Messenger", "fr_Viper"];
 _finalArray = [];

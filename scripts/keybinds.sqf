...
//Взаимодействие с машинами
	if(_key == 219 && cursorObject isKindOf 'landvehicle' && player distance cursorObject <= 4 && (getDammage cursorObject) <= 0.99 && lifeState player != "Incapacitated"|| _key == 220 && cursorObject isKindOf 'landvehicle' && player distance cursorObject <= 4 && (getDammage cursorObject) <= 0.99 && lifeState player != "Incapacitated" || _key == 219 && cursorObject isKindOf 'AIR' && player distance cursorObject <= 4 && (getDammage cursorObject) <= 0.99 && lifeState player != "Incapacitated"|| _key == 220 && cursorObject isKindOf 'AIR' && player distance cursorObject <= 4 && (getDammage cursorObject) <= 0.99 && lifeState player != "Incapacitated") then {createDialog "VehInteraction";}; //Winkey
};

	...
	HeavyVehArr = ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F", "I_MBT_03_cannon_F", "O_MBT_04_command_F", "O_MBT_02_cannon_F", "B_MBT_01_TUSK_F", "I_APC_tracked_03_cannon_F", "I_APC_Wheeled_03_cannon_F", "O_APC_Tracked_02_cannon_F", "I_LT_01_AA_F", "O_APC_Tracked_02_AA_F", "B_APC_Tracked_01_AA_F", "B_Heli_Transport_01_camo_F", "O_Heli_Light_02_F", "I_Heli_light_03_F", "O_Heli_Attack_02_F", "B_Heli_Attack_01_F"]; //AddHeavyVehToRaid - сюда боевая
...
//заносим поставленную технику в гараж
    ...
    _lifes = parseSimpleArray ("extDB3" callExtension format ["0:PenaUpal:SELECT I_MRAP_03_hmg_F, I_MRAP_03_gmg_F, I_MBT_03_cannon_F, O_MBT_04_command_F, O_MBT_02_cannon_F, B_MBT_01_TUSK_F, I_APC_tracked_03_cannon_F, I_APC_Wheeled_03_cannon_F, O_APC_Tracked_02_cannon_F, I_LT_01_AA_F, O_APC_Tracked_02_AA_F, B_APC_Tracked_01_AA_F, B_Heli_Transport_01_camo_F, O_Heli_Light_02_F, I_Heli_light_03_F, O_Heli_Attack_02_F, B_Heli_Attack_01_F FROM PlayerGarage WHERE UID='%1'",_uid]); 
    _lifes = _lifes # 1 # 0; 
	...
	_Lifes = [];
	//Земля
	_dbLifes = parseSimpleArray ("extDB3" callExtension format ["0:PenaUpal:SELECT I_MRAP_03_hmg_F, I_MRAP_03_gmg_F, I_MBT_03_cannon_F, O_MBT_04_command_F, O_MBT_02_cannon_F, B_MBT_01_TUSK_F, I_APC_tracked_03_cannon_F, I_APC_Wheeled_03_cannon_F, O_APC_Tracked_02_cannon_F, I_LT_01_AA_F, O_APC_Tracked_02_AA_F, B_APC_Tracked_01_AA_F FROM PlayerGarage WHERE UID='%1'",_uid]); 
	...
	for "_i" from 0 to count _dbLifes do {
		if (_dbLifes # _i != 0) then {
			switch (_i) do { 
				...
				case 2 : { _Lifes = _Lifes + ["I_MBT_03_cannon_F"]}; //Кума
				case 3 : {  _Lifes = _Lifes + ["O_MBT_04_command_F"] }; //Angara
				case 4 : { _Lifes = _Lifes + ["O_MBT_02_cannon_F"] }; //Varsuk
				case 5 : {  _Lifes = _Lifes + ["B_MBT_01_TUSK_F"] }; //Slammer
				case 6 : {  _Lifes = _Lifes + ["I_APC_tracked_03_cannon_F"] }; //Мора
				case 7 : { _Lifes = _Lifes + ["I_APC_Wheeled_03_cannon_F"] }; //Gorgone
				case 8 : { _Lifes = _Lifes + ["O_APC_Tracked_02_cannon_F"] }; //Камыш
				case 9 : { _Lifes = _Lifes + ["I_LT_01_AA_F"] }; //Нюкс ПВ
				case 10 : { _Lifes = _Lifes + ["O_APC_Tracked_02_AA_F"] }; //Tigris
				case 11 : {  _Lifes = _Lifes + ["B_APC_Tracked_01_AA_F"] }; //Cheetah
			};
